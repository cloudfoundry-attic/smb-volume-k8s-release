...
type FakePersistentVolumeInterface struct {
	CreateStub        func(context.Context, *v1a.PersistentVolume, v1b.CreateOptions) (*v1a.PersistentVolume, error)
	createMutex       sync.RWMutex
	createArgsForCall []struct {
		arg1 context.Context
		arg2 *v1a.PersistentVolume
	...
	GetStub        func(context.Context, string, v1b.GetOptions) (*v1a.PersistentVolume, error)
	...
	ListStub        func(context.Context, v1b.ListOptions) (*v1a.PersistentVolumeList, error)
	...
	PatchStub        func(context.Context, string, types.PatchType, []byte, v1b.PatchOptions, ...string) (*v1a.PersistentVolume, error)
	...
	UpdateStub        func(context.Context, *v1a.PersistentVolume, v1b.UpdateOptions) (*v1a.PersistentVolume, error)
	...
	UpdateStatusStub        func(context.Context, *v1a.PersistentVolume, v1b.UpdateOptions) (*v1a.PersistentVolume, error)
...
func (fake *FakePersistentVolumeInterface) Create(arg1 context.Context, arg2 *v1a.PersistentVolume, arg3 v1b.CreateOptions) (*v1a.PersistentVolume, error) {
...
func (fake *FakePersistentVolumeInterface) CreateCalls(stub func(context.Context, *v1a.PersistentVolume, v1b.CreateOptions) (*v1a.PersistentVolume, error)) {
	fake.createMutex.Lock()
	defer fake.createMutex.Unlock()
	fake.CreateStub = stub
}

func (fake *FakePersistentVolumeInterface) CreateArgsForCall(i int) (context.Context, *v1a.PersistentVolume, v1b.CreateOptions) {
	fake.createMutex.RLock()
	defer fake.createMutex.RUnlock()
...
func (fake *FakePersistentVolumeInterface) Delete(arg1 context.Context, arg2 string, arg3 v1b.DeleteOptions) error {
...
func (fake *FakePersistentVolumeInterface) DeleteCalls(stub func(context.Context, string, v1b.DeleteOptions) error) {
	fake.deleteMutex.Lock()
	defer fake.deleteMutex.Unlock()
	fake.DeleteStub = stub
}

func (fake *FakePersistentVolumeInterface) DeleteArgsForCall(i int) (context.Context, string, v1b.DeleteOptions) {
	fake.deleteMutex.RLock()
	defer fake.deleteMutex.RUnlock()
...
func (fake *FakePersistentVolumeInterface) DeleteCollection(arg1 context.Context, arg2 v1b.DeleteOptions, arg3 v1b.ListOptions) error {
...
func (fake *FakePersistentVolumeInterface) DeleteCollectionCalls(stub func(context.Context, v1b.DeleteOptions, v1b.ListOptions) error) {
	fake.deleteCollectionMutex.Lock()
	defer fake.deleteCollectionMutex.Unlock()
	fake.DeleteCollectionStub = stub
}

func (fake *FakePersistentVolumeInterface) DeleteCollectionArgsForCall(i int) (context.Context, v1b.DeleteOptions, v1b.ListOptions) {
	fake.deleteCollectionMutex.RLock()
	defer fake.deleteCollectionMutex.RUnlock()
...
func (fake *FakePersistentVolumeInterface) Get(arg1 context.Context, arg2 string, arg3 v1b.GetOptions) (*v1a.PersistentVolume, error) {
	fake.getMutex.Lock()
...
func (fake *FakePersistentVolumeInterface) GetCalls(stub func(context.Context, string, v1b.GetOptions) (*v1a.PersistentVolume, error)) {
	fake.getMutex.Lock()
	defer fake.getMutex.Unlock()
	fake.GetStub = stub
}

func (fake *FakePersistentVolumeInterface) GetArgsForCall(i int) (context.Context, string, v1b.GetOptions) {
	fake.getMutex.RLock()
	defer fake.getMutex.RUnlock()
...
func (fake *FakePersistentVolumeInterface) List(arg1 context.Context, arg2 v1b.ListOptions) (*v1a.PersistentVolumeList, error) {
	fake.listMutex.Lock()
...
func (fake *FakePersistentVolumeInterface) ListCalls(stub func(context.Context, v1b.ListOptions) (*v1a.PersistentVolumeList, error)) {
	fake.listMutex.Lock()
	defer fake.listMutex.Unlock()
	fake.ListStub = stub
}

func (fake *FakePersistentVolumeInterface) ListArgsForCall(i int) (context.Context, v1b.ListOptions) {
	fake.listMutex.RLock()
	defer fake.listMutex.RUnlock()
...
func (fake *FakePersistentVolumeInterface) Patch(arg1 context.Context, arg2 string, arg3 types.PatchType, arg4 []byte, arg5 v1b.PatchOptions, arg6 ...string) (*v1a.PersistentVolume, error) {
	var arg4Copy []byte
	if arg4 != nil {
...
func (fake *FakePersistentVolumeInterface) PatchCalls(stub func(context.Context, string, types.PatchType, []byte, v1b.PatchOptions, ...string) (*v1a.PersistentVolume, error)) {
	fake.patchMutex.Lock()
	defer fake.patchMutex.Unlock()
	fake.PatchStub = stub
}

func (fake *FakePersistentVolumeInterface) PatchArgsForCall(i int) (context.Context, string, types.PatchType, []byte, v1b.PatchOptions, []string) {
	fake.patchMutex.RLock()
	defer fake.patchMutex.RUnlock()
...
func (fake *FakePersistentVolumeInterface) Update(arg1 context.Context, arg2 *v1a.PersistentVolume, arg3 v1b.UpdateOptions) (*v1a.PersistentVolume, error) {
...
func (fake *FakePersistentVolumeInterface) UpdateCalls(stub func(context.Context, *v1a.PersistentVolume, v1b.UpdateOptions) (*v1a.PersistentVolume, error)) {
	fake.updateMutex.Lock()
	defer fake.updateMutex.Unlock()
	fake.UpdateStub = stub
}

func (fake *FakePersistentVolumeInterface) UpdateArgsForCall(i int) (context.Context, *v1a.PersistentVolume, v1b.UpdateOptions) {
	fake.updateMutex.RLock()
	defer fake.updateMutex.RUnlock()
...
func (fake *FakePersistentVolumeInterface) UpdateStatus(arg1 context.Context, arg2 *v1a.PersistentVolume, arg3 v1b.UpdateOptions) (*v1a.PersistentVolume, error) {
...
func (fake *FakePersistentVolumeInterface) UpdateStatusCalls(stub func(context.Context, *v1a.PersistentVolume, v1b.UpdateOptions) (*v1a.PersistentVolume, error)) {
	fake.updateStatusMutex.Lock()
	defer fake.updateStatusMutex.Unlock()
	fake.UpdateStatusStub = stub
}

func (fake *FakePersistentVolumeInterface) UpdateStatusArgsForCall(i int) (context.Context, *v1a.PersistentVolume, v1b.UpdateOptions) {
	fake.updateStatusMutex.RLock()
	defer fake.updateStatusMutex.RUnlock()
...
func (fake *FakePersistentVolumeInterface) Watch(arg1 context.Context, arg2 v1b.ListOptions) (watch.Interface, error) {
...
func (fake *FakePersistentVolumeInterface) WatchCalls(stub func(context.Context, v1b.ListOptions) (watch.Interface, error)) {
	fake.watchMutex.Lock()
	defer fake.watchMutex.Unlock()
	fake.WatchStub = stub
}

func (fake *FakePersistentVolumeInterface) WatchArgsForCall(i int) (context.Context, v1b.ListOptions) {
	fake.watchMutex.RLock()
	defer fake.watchMutex.RUnlock()
